...
// =====================================================================
// Helpers canonicos para groupBy de tablas (chip de fecha + subtotal).
// Patron unico para todas las pantallas que agrupen por dia: chip 2-lineas
// (DD grande + MES) + label relativo (Hoy/Ayer/Mañana) + count.
// =====================================================================
