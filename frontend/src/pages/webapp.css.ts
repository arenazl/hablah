...
.webapp-root .mic-wave { flex: 1; display: flex; align-items: center; justify-content: space-between; gap: 3px; height: 36px; min-width: 0; }
.webapp-root .mic-wave i { display: block; flex: 1; min-width: 2px; max-width: 6px; background: var(--primary); border-radius: 2px; opacity: .9; }
