...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 584 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 2.9s · máx 3.8s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Mi familia"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Mi familia".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Mi familia" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Mi familia" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Mi familia" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 3.3s]: ¡Hola, Timo! Imaginate que tu familia vive en una isla secreta y vamos a visitarlos. ¿Visitamos primero a tu MOM?
NENE: ¡Mi mami! Sí, sí.
