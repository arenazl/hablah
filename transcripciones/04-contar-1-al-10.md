...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 139 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 2.9s · máx 5.2s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Contar del 1 al 10"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Contar del 1 al 10".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Contar del 1 al 10" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Contar del 1 al 10" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Contar del 1 al 10" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 3.3s]: ¡Hola Timo! Hoy vamos a viajar al espacio, ¡somos recolectores de estrellas mágicas!
NENE: ¡Guau! ¿Estrellas?
