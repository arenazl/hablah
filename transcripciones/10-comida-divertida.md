...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 131 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 3.3s · máx 9.2s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Comida divertida"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Comida divertida".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Comida divertida" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Comida divertida" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Comida divertida" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 9.2s]: ¡Timo, somos cocineros divertidos hoy! ¡Para empezar este helado monstruoso, decí conmigo: ICE CREAM!
