# 08 · Dibujitos y superhéroes (mini · A0)
...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 138 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 3.5s · máx 6.4s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Dibujitos y superhéroes"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Dibujitos y superhéroes".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Dibujitos y superhéroes" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Dibujitos y superhéroes" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Dibujitos y superhéroes" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 6.4s]: ¡Hola, Timo, vamos a dibujar SUPERHEROES que salvan a un amigo!
