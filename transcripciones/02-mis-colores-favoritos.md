# 02 · Mis colores favoritos (mini · A0)
...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 113 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 2.7s · máx 4.0s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Mis colores favoritos"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Mis colores favoritos".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Mis colores favoritos" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Mis colores favoritos" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Mis colores favoritos" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 2.7s]: ¡Hola, Timo! Hoy vamos a rescatar el arcoíris porque perdió sus colores.
NENE: ¡Sí! ¿El arcoíris?
