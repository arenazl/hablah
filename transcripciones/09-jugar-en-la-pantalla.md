# 09 · Jugar en la pantalla (mini · A0)
...
## Medición real (infra)
- **Setup** (`POST /sessions/start`): 127 ms
- **Latencia del coach** (1er chunk, Gemini Live native-audio): prom 3.2s · máx 4.5s

## Las 4 patas

### 1) TÓPICO — qué se habla (agnóstico al nivel)
**"Jugar en la pantalla"** · segmento: mini · audiencia: niños. El tópico es solo el tema; no trae vocabulario ni reglas.
...
EL MUNDO DE HOY: "Jugar en la pantalla".
PALABRAS en inglés para tejer en la historia (anclas, NO una lista para recitar): 3-5 palabras simples y visuales de "Jugar en la pantalla" (las elegís vos, del tema).

CÓMO SE LLEVA LA CLASE (narrativa de espina — no negociable):
- Armá una MINI-AVENTURA / cuento sobre "Jugar en la pantalla" donde el chico es el PROTAGONISTA y decide qué pasa. La historia AVANZA en cada turno.
...
ARRANQUE: saludá a Timo por su nombre en Spanish y ABRÍ la historia de hoy sobre "Jugar en la pantalla" con un gancho (algo que pasa, un problemita divertido). Esperá que responda.
```

## Transcripción (clase por la infra real)
```
HABI [apertura · 3.2s]: ¡Hola, Timo! ¡Te metiste adentro de la SCREEN! Ahora sos el capitán espacial — ¿podés decir SCREEN?
