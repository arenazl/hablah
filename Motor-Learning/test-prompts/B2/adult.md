...
- **id_alumno:** ficticio · **edad:** 30 → **segmento `adult`** · **nivel:** `B2`
...
<current_lesson_vocabulary>
  ...
  Target_Phrases: we're gonna have scaling problems, the codebase is a mess, how do we keep this maintainable, there's gonna be bottlenecks, let's think about the big picture, that won't work when it grows, do we handle this gracefully, we need better separation of concerns, the infrastructure's gotta support it, it's becoming unmaintainable
</current_lesson_vocabulary>
