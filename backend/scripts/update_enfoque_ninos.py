...
ENFOQUE_NINOS = (
    ...
    "AVANCE: a lo largo de la clase andá sumando palabras NUEVAS; no te quedes machacando la misma 3-4 veces. "
    "Cuando el chico ya la dijo bien, festejá y AVANZÁ a la siguiente; la anterior puede reaparecer suelta en la "
    "historia, pero el foco se mueve. Una clase = varias palabras encadenadas, no una repetida.\n"
