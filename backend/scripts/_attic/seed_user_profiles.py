...
PROFILES = [
    # Teens (13-17) — adultos para el motor pedagógico (age_group = "teen")
    {"nombre": "Lucas",      "apellido": "Fernandez", "age_group": "teen",        "english_self_level": "zero",         "cefr_level": "A0", "occupation": "Estudiante secundaria", "learning_goal": "estudio",   "email": "lucas.f@demo.hablah.app"},
    {"nombre": "Sofia",      "apellido": "Gomez",     "age_group": "teen",        "english_self_level": "survival",     "cefr_level": "A1", "occupation": "Estudiante secundaria", "learning_goal": "estudio",   "email": "sofia.g@demo.hablah.app"},
    ...
    {"nombre": "Ignacio",    "apellido": "Blanco",    "age_group": "young_adult", "english_self_level": "zero",         "cefr_level": "A0", "occupation": "Musico independiente",  "learning_goal": "hobby",     "email": "igna.b@demo.hablah.app"},
    # Adults (30-60)
    ...
    {"nombre": "Rodrigo",    "apellido": "Medina",    "age_group": "adult",       "english_self_level": "advanced",     "cefr_level": "C1", "occupation": "Medico",                "learning_goal": "estudio",   "email": "rodri.m@demo.hablah.app"},
    ...
    # Adults migracion / emprendedores
    {"nombre": "Pablo",      "apellido": "Diaz",      "age_group": "adult",       "english_self_level": "survival",     "cefr_level": "A1", "occupation": "Gastronomico",          "learning_goal": "migracion", "email": "pablo.d@demo.hablah.app"},
    ...
    {"nombre": "Eduardo",    "apellido": "Rios",      "age_group": "senior",      "english_self_level": "basic",        "cefr_level": "A2", "occupation": "Medico jubilado",       "learning_goal": "hobby",     "email": "eduardo.r@demo.hablah.app"},
]
