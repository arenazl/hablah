# Orquestación · teen · A0 · Zapatillas y moda urbana
...
<current_lesson_vocabulary>
  Topic: Zapatillas y moda urbana
  Words: sneakers, drop, limited, outfit, style, fit
  Target_Phrases: fresh out the box
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Zapatillas y moda urbana ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
