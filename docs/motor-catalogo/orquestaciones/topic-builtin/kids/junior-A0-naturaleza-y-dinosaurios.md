# Orquestación · junior · A0 · Naturaleza y dinosaurios
...
<current_lesson_vocabulary>
  Topic: Naturaleza y dinosaurios
  Words: forest, ocean, mountain, dinosaur, jungle, tree
  Target_Phrases: dinosaurs are cool
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Naturaleza y dinosaurios. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
