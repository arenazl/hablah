# Orquestación · junior · A0 · Coleccionar cartas y figuritas
...
<current_lesson_vocabulary>
  Topic: Coleccionar cartas y figuritas
  Words: collection, trade, rare, common, card, figure
  Target_Phrases: collect them all
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Coleccionar cartas y figuritas. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
