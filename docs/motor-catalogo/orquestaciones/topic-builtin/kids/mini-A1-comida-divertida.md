# Orquestación · mini · A1 · Comida divertida
...
<current_lesson_vocabulary>
  Topic: Comida divertida
  Words: burger, fries, nuggets, popcorn, candy, ice cream
  Target_Phrases: candy you're obsessed with
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Comida divertida respetando el Language_Rule del nivel. Presentá burger usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
