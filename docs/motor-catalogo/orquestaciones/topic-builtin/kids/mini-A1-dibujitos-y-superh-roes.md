# Orquestación · mini · A1 · Dibujitos y superhéroes
...
<current_lesson_vocabulary>
  ...
  Words: hero, fast, strong, fly, save, funny
  Target_Phrases: cartoons you're into right now
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Dibujitos y superhéroes respetando el Language_Rule del nivel. Presentá hero usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
