# Orquestación · mini · A2 · Comidas ricas
...
<current_lesson_vocabulary>
  Topic: Comidas ricas
  Words: apple, bread, milk, rice, egg, banana
  Target_Phrases: what's your favorite food in the world
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Comidas ricas respetando el Language_Rule del nivel. Presentá apple usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
