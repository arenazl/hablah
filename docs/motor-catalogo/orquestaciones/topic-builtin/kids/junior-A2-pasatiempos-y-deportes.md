# Orquestación · junior · A2 · Pasatiempos y deportes
...
<current_lesson_vocabulary>
  ...
  Words: soccer, basketball, draw, music, play, swim
  Target_Phrases: hobbies you're into
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Pasatiempos y deportes. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
