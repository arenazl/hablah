# Orquestación · teen · A0 · Viajes y culturas
...
<current_lesson_vocabulary>
  Topic: Viajes y culturas
  Words: travel, country, culture, language, city, trip
  Target_Phrases: off the beaten path
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Viajes y culturas ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
