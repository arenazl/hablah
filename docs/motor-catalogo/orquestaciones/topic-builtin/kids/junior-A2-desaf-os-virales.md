# Orquestación · junior · A2 · Desafíos virales
...
<current_lesson_vocabulary>
  Topic: Desafíos virales
  Words: challenge, subscriber, viral, reaction, prank, video
  Target_Phrases: the challenge
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Desafíos virales. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
