# Orquestación · teen · A2 · Cocinar y recetas
...
<current_lesson_vocabulary>
  Topic: Cocinar y recetas
  Words: recipe, cook, bake, ingredient, taste, sweet
  Target_Phrases: from scratch
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Cocinar y recetas ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
