# Orquestación · mini · A1 · Mi cuerpo
...
<current_lesson_vocabulary>
  Topic: Mi cuerpo
  Words: head, nose, eye, mouth, hand, foot
  Target_Phrases: what body parts can you point to
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Mi cuerpo respetando el Language_Rule del nivel. Presentá head usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
