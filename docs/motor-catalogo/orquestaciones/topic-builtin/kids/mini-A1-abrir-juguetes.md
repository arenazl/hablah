# Orquestación · mini · A1 · Abrir juguetes
...
<current_lesson_vocabulary>
  Topic: Abrir juguetes
  Words: box, open, surprise, toy, gift, new
  Target_Phrases: new toys you got recently
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Abrir juguetes respetando el Language_Rule del nivel. Presentá box usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
