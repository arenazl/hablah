# Orquestación · junior · A0 · Comida rápida y dulces
...
<current_lesson_vocabulary>
  Topic: Comida rápida y dulces
  Words: combo, burger, fries, soda, ice cream, menu
  Target_Phrases: let's go get some
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Comida rápida y dulces. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
