# Orquestación · teen · A2 · Cuidar el planeta
...
<current_lesson_vocabulary>
  Topic: Cuidar el planeta
  Words: recycle, pollution, climate, ocean, plastic, animal
  Target_Phrases: do our part
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Cuidar el planeta ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
