# Orquestación · junior · A2 · Mundos de bloques
...
<current_lesson_vocabulary>
  Topic: Mundos de bloques
  Words: build, block, craft, mine, create, server
  Target_Phrases: build something
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre Mundos de bloques. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
