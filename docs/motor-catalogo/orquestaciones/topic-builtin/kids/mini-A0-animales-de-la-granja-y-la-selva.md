# Orquestación · mini · A0 · Animales de la granja y la selva
...
<current_lesson_vocabulary>
  ...
  Words: animal, cow, dog, cat, lion, elephant
  Target_Phrases: what animal's your favorite
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Animales de la granja y la selva respetando el Language_Rule del nivel. Presentá animal usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
