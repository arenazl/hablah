# Orquestación · teen · A1 · Streamers y transmisiones
...
<current_lesson_vocabulary>
  Topic: Streamers y transmisiones
  Words: live, stream, chat, follow, donate, clip
  Target_Phrases: go live
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Streamers y transmisiones ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
