# Orquestación · teen · A0 · Decir lo que pensás
...
<current_lesson_vocabulary>
  Topic: Decir lo que pensás
  Words: think, agree, disagree, opinion, because, however
  Target_Phrases: speak your mind
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Decir lo que pensás ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
