# Orquestación · teen · A2 · Slang y tendencias online
...
<current_lesson_vocabulary>
  Topic: Slang y tendencias online
  Words: slang, trend, vibe, hype, flex, cringe
  Target_Phrases: that's so cringe
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Slang y tendencias online ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
