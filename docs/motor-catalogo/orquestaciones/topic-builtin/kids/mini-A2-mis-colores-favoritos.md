# Orquestación · mini · A2 · Mis colores favoritos
...
<current_lesson_vocabulary>
  Topic: Mis colores favoritos
  Words: color, red, blue, yellow, green, purple
  Target_Phrases: what color do you love the most
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con mucha energía. Presentá el tema Mis colores favoritos respetando el Language_Rule del nivel. Presentá color usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
