# Orquestación · teen · A2 · Gaming pro y esports
...
<current_lesson_vocabulary>
  Topic: Gaming pro y esports
  Words: team, tournament, rank, pro, competitive, strategy
  Target_Phrases: go pro
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Gaming pro y esports ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
