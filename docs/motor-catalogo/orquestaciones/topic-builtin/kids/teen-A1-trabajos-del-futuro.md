# Orquestación · teen · A1 · Trabajos del futuro
...
<current_lesson_vocabulary>
  Topic: Trabajos del futuro
  Words: job, career, engineer, designer, scientist, creator
  Target_Phrases: what I want to be
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) con onda y planteá el reto de hoy sobre Trabajos del futuro ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
