# Orquestación · junior · A0 · La escuela
...
<start_execution_command>
  Command: Saludá a (perfil vacío · sin historia) y presentá la MISIÓN sobre La escuela. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
