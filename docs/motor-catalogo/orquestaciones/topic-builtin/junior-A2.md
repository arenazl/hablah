# Orquestación (tópico enchufado) · Junior (8-12) · A2

> Motor ACTUAL (v2). Tópico REPRESENTATIVO: **La escuela**. El marco es el mismo para
> TODOS los tópicos de esta celda; **solo cambia el bloque `current_lesson_vocabulary`**
> (título + palabras). El marco puro está en `../agnosticas/junior-A2.md`.
...
<current_lesson_vocabulary>
  Topic: La escuela
  Words: school, teacher, friend, class, lunch, recess
  Target_Phrases: what's school actually like
</current_lesson_vocabulary>

<start_execution_command>
  Command: Saludá a ‹NOMBRE› y presentá la MISIÓN sobre La escuela. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
