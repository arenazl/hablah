# Orquestación AGNÓSTICA · Junior (8-12) · A2
...
<start_execution_command>
  Command: Saludá a ‹NOMBRE› y presentá la MISIÓN sobre ‹TÓPICO del cruce›. Arrancá con la primera consigna, ofreciendo una opción A/B para avanzar la historia.
</start_execution_command>
