# Orquestación AGNÓSTICA · Teen (13-17) · A1
...
<start_execution_command>
  Command: Saludá a ‹NOMBRE› con onda y planteá el reto de hoy sobre ‹TÓPICO del cruce› ('Challenge 1, ready?'). Trato de igual, nada infantil.
</start_execution_command>
