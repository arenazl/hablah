# Orquestación AGNÓSTICA · Mini (4-7) · A2
...
<start_execution_command>
  Command: Saludá a ‹NOMBRE› con mucha energía. Presentá el tema ‹TÓPICO del cruce› respetando el Language_Rule del nivel. Presentá ‹palabra-1› usando el patrón exacto de Expected_Production. Cerrá con la invitación del patrón. Una sola interacción. Esperá su respuesta.
</start_execution_command>
